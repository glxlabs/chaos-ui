...
const HeroSection: React.FC = () => {
  ...
  const handleInstallCopy = async () => {
    await copy("npm install @glitchlabs/chaosui");
  };
        ...
        <div className="text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              ...
              {copied ? "Copied!" : "npm install @glitchlabs/chaosui"}
            </Button>
                ...
                <div className="text-left">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => copy(`import { Button } from "@glitchlabs/chaosui";`)}
                    >
                      <Copy className="w-4 h-4" />
                    </Button>
                  </div>
                  <code className="text-sm text-cyber-white font-mono">
                    {`import { Button } from "@glitchlabs/chaosui";`}
                  </code>
                </div>
